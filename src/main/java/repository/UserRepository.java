...
public class UserRepository {
	public int checkExistingOfUserByEmailNPassword(String email, String password) {
		int count = 0;
	...
	public int checkExistingOfUserByRoleId(int roleId) {
		int count = 0;
		Connection connection = DbConfig.getMySQLConnection();
	...
	public List<UserModel> getAllUser() {
		...
		Connection connection = DbConfig.getMySQLConnection();
		String query = "SELECT u.id, u.email, u.fullname, r.name AS role_name "
				+ "FROM users AS u LEFT JOIN roles AS r ON u.role_id = r.id " + "ORDER BY u.role_id";
	...
	public int editUser(UserModel user) {
		...
		Connection connection = DbConfig.getMySQLConnection();
		String query = "UPDATE users AS u SET u.email = ?, u.password = ?, u.fullname = ?, u.avatar = ?, u.role_id = ? WHERE u.id = ?";
